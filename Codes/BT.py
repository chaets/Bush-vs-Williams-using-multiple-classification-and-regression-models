...
# X_pca = pca.fit(X).transform(X)
# print('For C value in Linear:128')
...
svc = 'SVC_test_f1: 0.49259259'
KNN = 'KNN_test_f1: 0.21682099'
print("PICKLING ...")
# pickle.dump((bush),open('BUSH.pkl','wb'))
pickle.dump((KNN,svc ),open('D:\\MCS\\Sem 3\\Machine Learning\\Codes\\project\\Phase 2\\williams.pkl','wb'))