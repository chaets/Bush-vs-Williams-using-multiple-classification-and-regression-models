...
#         stratified_cv_results_K = cross_validate(knn, X_pca, y_williams,
...
#         stratified_cv_results_L = cross_validate(svc, X_pca, y_williams,
#                                                  cv=StratifiedKFold(n_splits=3, shuffle=True, random_state=8854),
#                                                  scoring=('precision', 'recall', 'f1'), return_train_score=False)
...
for cv in n_comps_val:
    ...
    for CS in C_set:
        ...
        for d in deg:
            ...
            stratified_cv_results_PD = cross_validate(svc, X_pca, y_williams,
                                                      cv=StratifiedKFold(n_splits=3, shuffle=True, random_state=8854),
                                                      scoring=('precision', 'recall', 'f1'), return_train_score=False)
...
#             stratified_cv_results_RG = cross_validate(svc, X_pca, y_williams,
#                                                       cv=StratifiedKFold(n_splits=3, shuffle=True, random_state=8854),
#                                                       scoring=('precision', 'recall', 'f1'), return_train_score=False)
...
#     print('For C value in rgf with Gamma: ', G)
#     stratified_cv_results_RGA = cross_validate(svc, X_pca, y_williams,
#                                            cv=StratifiedKFold(n_splits=3, shuffle=True, random_state=8854),
#                                            scoring=('precision', 'recall', 'f1'), return_train_score=False)
